			...
			.ready(
					function() {
						...
						var fileContent = document
								.getElementById("fileContent").value;
						var fin = fileContent.replace(/~/g, "\"");

						$('#myDiv').html(fin);
						
						var count = document.getElementById('lCount').value;
						var rTCount = document.getElementById('rTCount').value;
						
						
						$('.right .drag').draggable({ /* makes elements draggable */
							revert : true,
							proxy : 'clone'
						});
						/* specifying droppable property */
						$('.left td.drop')
								.droppable(
										{
											...
											onDrop : function(e, source) {
												...
												var s = $(source).attr('id'); /* fetches the id of the item that is being draggesd */
